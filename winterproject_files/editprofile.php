...
?>
<table align = "center" align  width = 1000 bgcolor = 'red'>
    <tr><td width = 300><?php include 'chechkandshowprofilepicwithoutsession.php'; chechkandshowprofilepic(); ?><br></br>
            <form action="editprofilepic.php" method="POST">
                <input type="submit" value="ChangeProfilePic" name="upload">
            </form>
        </td>
        <td width = 700>
            <table align = 'center' >
                ...
                <tr><td align = 'right' ><a href = 'afterposts.php' > Home </a></td>
